...
insert into public.site_settings (key, value) values
  ...
  ('registration_pricing', '{"plan":{"badge":"Best Plan","title":"In-Person","price":600,"currency":"MAD","features":["Communication Certificate","Certificate of Participation","Conference Materials","Access to Exhibitions","Lunch and Tea/Coffee Breaks","Conference Documents","Briefcase | Proceedings Report","Notebook | Pen","Badge | Brochure | Program"]}}'::jsonb)
