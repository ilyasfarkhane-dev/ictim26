...
insert into public.site_settings (key, value) values
  (
    'hero_content',
    '{"badge":"International Conference · TIM Laboratory","fullName":"The 8th International Conference on Information Technology and Modeling","title":"ICTIM''26","subtitle":"Information Technology & Modeling","tagline":"Innovation and Trends in Computer Science and Modeling: Bridging Theory, Practice, and the Power of AI","publication":"Extended versions of selected papers are submitted to Scopus-indexed journals.","dates":"November 26 – 27, 2026","venue":"Faculty of Sciences Ben M''Sik | Casablanca - Morocco","ctas":[{"id":"cta-primary","label":"Call for Papers","href":"#call-for-papers","variant":"primary","enabled":true},{"id":"cta-secondary","label":"Important Dates","href":"#important-dates","variant":"secondary","enabled":true}]}'::jsonb
  )
